...
cena_burgeru=15
sytost=4
mistnost_s_klicem = random.choice([1,5,6,7,9,10])
mistnost_s_hasicakem = 2
mistnost_s_pasti = random.choice([1,6,7])
zlato = [1, 0, 10, 100,15,20,3,0,50,30,0,9]
hrac = 0
skore = 0
kroky = 0
prisera = None
mistnost_s_baziliskem = 11
mistnost_s_náhrdelnikem = random.choice([6,7])
